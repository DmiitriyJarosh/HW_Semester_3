...
import static Image.Filter.AVERAGE_9X9_HALF_SIZE;
import static Image.Filter.AVERAGE_9X9_SQUARE;

public class FilterAverage implements Runnable{
    ...
    public FilterAverage(int heightStart, int heightFinish, int width, int height, BufferedImage image, BufferedImage newImage) {
        this.image = image;
        this.height = height;
